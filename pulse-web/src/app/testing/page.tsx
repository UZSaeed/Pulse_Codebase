...
export default function TestingLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-navy-900 flex items-center justify-center px-4">
      {/* Background glow */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-neon-blue/8 rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* Login Card */}
        <div className="bg-navy-800/80 backdrop-blur-sm border border-navy-700 rounded-2xl p-8">
          {error && (
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-semibold py-3.5 px-6 rounded-xl hover:bg-gray-50 transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.15)] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
